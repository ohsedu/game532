...
export const GAME_LIST: readonly GameMeta[] = [
  {
    ...
    controls: "방향키로 이동 · S 부스터 · D 레이저 · 총알을 스칠수록 GRAZE 보너스",
    keys: "↑ ↓ ← → 이동 · S 부스터 · D 레이저",
    accent: "#4f8cff",
    touch: "joystick-laser",
  },
  {
    id: "poop",
    no: "02",
    ...
    controls: "방향키로 이동 · S 부스터 · 아슬아슬하게 피하면 NEAR MISS 보너스",
    keys: "↑ ↓ ← → 이동 · S 부스터",
    accent: "#ffa62b",
    touch: "joystick",
  },
  ...
  },
  {
    ...
    controls: "뛰고, 미끄러지고, 부술 건 대시로 · 아슬아슬할수록 보너스",
    keys: "↑ 점프 (길게 누르면 높이) · ↓ 슬라이드 · → 대시",
    accent: "#a77bff",
