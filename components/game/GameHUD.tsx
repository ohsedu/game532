...
function GameHUD({
  ...
  return (
    <div className="hud-inner pointer-events-none flex items-start justify-between gap-2 p-4">
      <div className="rounded-2xl bg-white/45 px-4 py-2.5 backdrop-blur-[2px]">
      ...
      <div className="flex items-start gap-2">
        {stats.length > 0 ? (
          <div className="flex gap-4 rounded-2xl bg-white/45 px-4 py-2.5 backdrop-blur-[2px]">
            {stats.map((s) => (
        ...
        <button
          ...
          className="pointer-events-auto flex h-10 w-10 items-center justify-center rounded-full bg-white/55 text-sm backdrop-blur-[2px] transition-colors hover:bg-white/90"
